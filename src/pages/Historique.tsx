  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-foreground mb-2">Historique des Paris</h1>
          <p className="text-muted-foreground">Consultez tous vos paris passés et en cours</p>
        </div>
