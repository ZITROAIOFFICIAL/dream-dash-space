    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="grid gap-6">
          <Card className="max-w-3xl bg-white border-2 border-gray-300 shadow-2xl overflow-hidden">
            {/* AI Analysis Badge */}
            <div className="bg-gradient-to-r from-primary via-primary/80 to-primary px-6 py-4 flex items-center justify-center border-b-2 border-white shadow-[0_0_30px_rgba(255,255,255,0.3)] rounded-t-lg">
